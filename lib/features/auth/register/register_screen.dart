...
class _RegisterScreenState extends State<RegisterScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _slide = Tween<Offset>(begin: const Offset(0, 0.2), end: Offset.zero).animate(CurvedAnimation(parent: _entryCtrl, curve: Curves.easeOutExpo));
    _entryCtrl.forward();
  ...
  Color _strengthColor(String s) {
    switch (s) {
      ...
      case 'Moyen': return Colors.orangeAccent;
      case 'Fort': return AppColors.tropicalGreen;
      case 'Très fort': return AppColors.appleGreen;
